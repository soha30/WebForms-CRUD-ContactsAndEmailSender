<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="myServiceControl.aspx.cs" Inherits="soha_f6269.Demo.myServiceControl" %>
        ...
        <table class="nav-justified">
            ...
            <tr>
                ...
                <td style="height: 20px">
                    <asp:TextBox ID="txtlNmae" runat="server" Width="128px"></asp:TextBox>
                </td>
            </tr>
            <tr>
