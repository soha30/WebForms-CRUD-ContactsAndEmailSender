   ...
   public class CRUD
    {
        ...
        public static string conStr = WebConfigurationManager.ConnectionStrings["Ali_1988ConnectionString"].ConnectionString;
        // I create a con object once and then use it in methods
        public SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["Ali_1988ConnectionString"].ConnectionString);
        //public SqlConnection localCon = new SqlConnection("Data Source=SOHAABDURAHMAN\\SQLEXP2017; Initial Catalog=Ali_1988; User ID=sa; Password=1981;");
        ...
        internal void InsertUpdateDelete()
        {
